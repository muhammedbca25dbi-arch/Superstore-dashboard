...
def load_data():
    return pd.read_csv(
        r"C:\Users\muham\OneDrive\Desktop\project4.1\Output\superstore_cleaned.csv",
...
with tab4:
    ...
    mean_margin = (filtered["profit"].sum() / sales_total) * 100 if sales_total else 0.0
