...
selected_categories = st.multiselect("Select Categories",options=all_categories,default=all_categories)
...
st.caption(
    f"Created by Your Mohammed KV| Personal Expense Tracker | {today}"
)
